...
import { laravelTechnologies } from '@/components/hire/laravel/laravelTechnologies';
import { getHireHeroImage } from '@/lib/serviceHeroImages';
import { hireAuditMetadata } from '@/lib/auditMetadata';

export const metadata = hireAuditMetadata('laravel-developer');


const HERO_IMAGE = getHireHeroImage('laravel-developer');

const whyHireContent = {
  title: 'Why Hire Laravel Developers From Nexuron Technologies?',
  imageAlt: 'Nexuron Laravel development team',
  description:
    'Behind every high performing Laravel application is a team that obsesses over the details most developers skip architecture, security, performance, and long term code health. That\'s the standard we hold ourselves to, on every project, for every client.',
  benefits: [
    'Experienced Laravel Developers',
    'Strong PHP & Laravel Framework Expertise',
...
const expertiseContent = {
  expertiseTitle: 'Our Laravel Development Expertise',
  expertise: [
    {
      title: 'Custom Laravel Web Development',
      description:
        'Build robust, scalable web applications tailored to your business requirements using Laravel best practices.',
    },
    {
      title: 'Laravel API Development',
      description:
        'Develop secure RESTful APIs and backend services for web and mobile applications.',
    },
    {
      title: 'Enterprise Laravel Solutions',
      description:
        'Design and build enterprise-grade systems with clean architecture, queues, and caching strategies.',
    },
    {
      title: 'Third-Party Integrations',
      description:
        'Seamlessly integrate payment gateways, CRMs, ERPs, and third-party services into your Laravel application.',
    },
    {
      title: 'Laravel Performance Optimization',
      description:
        'Improve application speed, database queries, and overall system efficiency.',
    },
    {
...
const faqs = [
  {
    question: 'How quickly can I hire a Laravel developer?',
    answer:
      'You can onboard a dedicated Laravel developer within 48-72 hours after requirement discussion.',
  },
  {
...
const PROCESS_STEPS = buildProcessSteps('Laravel');

const ENGAGEMENT_MODELS = buildEngagementModels('Laravel', 'Laravel Developer');
...
export default function HireLaravelDeveloperPage() {
  return (
    <main>
        ...
        <div className="relative z-10 max-w-[1340px] mx-auto px-4 sm:px-6 lg:px-8 min-h-[560px] md:min-h-[620px] flex items-center pt-12 pb-12">
          <div className="w-full max-w-xl text-white">
            <h1 className="text-3xl md:text-4xl lg:text-[40px] font-bold italic tracking-wide leading-tight">
              Hire Laravel Development Experts
            </h1>
            <p className="mt-5 text-[13px] md:text-[14px] font-normal leading-7 text-gray-100">
              Build scalable, secure, and high-performance web applications with our expert Laravel developers. We specialize in custom Laravel development, RESTful APIs, and modern PHP best practices tailored to your business needs.
            </p>
      ...
      <HireTechStack
        bg="white"
        title="Technologies Our Laravel Developers Use"
        technologies={laravelTechnologies}
      />

      <HireProcessPanel
        bg="muted" title="How Hiring a Laravel Developer Works" steps={PROCESS_STEPS} />

      <HireEngagementCards
        bg="white" models={ENGAGEMENT_MODELS} />

      <HireInquiryPanel
        bg="muted" roleTitle="Laravel Developer" serviceName="Laravel Development" />
